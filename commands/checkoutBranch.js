export default {
	...
	aliases: ['co', 'clone'],
	describe: "checkout branch into current directory",
	builder: {
		...
		b: { default: false, type: 'boolean', describe: 'set to true to create branch if it does not exist' }
	},
	handler: async function switchBranch({ svn, b, branch, branchNumber, targetName, target }) {
		...
		svn.log({ branchExists, b, activeBranch, target});
