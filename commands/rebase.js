...
export default {
	...
	handler: async function rebase({ target, jira, source, branch, resolve, svn }) {
		...
		await jira.updateBranch(targetBranchName.split('-')[0], targetBranchName.split('-')[1], targetBranchName)
